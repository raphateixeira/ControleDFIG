...
- [Identificação de Modelos ARX por Mínimos Quadrados](https://raphateixeira.github.io/Identificacao/Identificacao/Ident03ARXMinimosQuadrados.html) (Identificacao) — fundamentos do estimador ARX por mínimos quadrados usado aqui, no caso escalar mais simples.
- [ControleCC2CC](https://raphateixeira.github.io/ControleCC2CC/) — mesmo estimador ARX aplicado a conversores de potência monofásicos.
- [DeePC — Data-Enabled Predictive Control](https://raphateixeira.github.io/DataDrivenControl/DeePC/DeePCNota.html) (DataDrivenControl) — controle preditivo direto sobre dados, sem passar por um modelo ARX explícito como o daqui.
